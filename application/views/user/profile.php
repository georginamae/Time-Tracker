                ...
                <div class="page-content-wrap">                     
					...
					<div class=" grid">                        
                        <div class="unit w-1-3">
                            ...
                            <form action="<?php echo base_url('user/edit/process/save-login'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data" >
                        ...
                        <div class="unit w-1-3">
                            ...
                            <form action="<?php echo base_url('user/edit/process/save-profile'); ?>" method="post" class="form-horizontal">
                            <div class="panel panel-default">
                                <div class="panel-body">
								<?php 
