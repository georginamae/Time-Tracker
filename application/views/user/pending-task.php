            ...
            <div class="mb-container ">
                <div class="mb-middle ">
                    ...
                    <div class="mb-content form-group-separated">
                       <form action="<?=base_url('user/edit/process/add-time-entry')?>" method="POST" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-xs-12">                                            
									<div class="input-group">
										...
										<input name="txtPercent" id="txtPercent" type="number" value="" max="100" class="form-control" />
									</div>                                            
								</div>
							</div>	
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-xs-12">                                            
									<div class="input-group">
										...
										<input name="txtHours" id="txtHours" type="number" value="" min="0" class="form-control" step="0.01" />
									</div>                                            
								</div>
							</div>	
