<?php get_header('Deactivated Users','admin admin-deactivated-users'); ?>
        <div class="page-container">
            ...
            <div class="page-content">        
                ...
                <div class="page-content-wrap">                     
					<?php page_title("fa-trash-o","Deactivated Users"); ?>	
					<div class="grid">
					<div class="unit w-1-1">
						<form class="form-horizontal" action="<?php echo base_url('admin/edit/process/activate-users'); ?>" method="POST" >
