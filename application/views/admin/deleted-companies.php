<?php get_header('Trash','admin deleted-companies'); ?>
        <div class="page-container">
            ...
            <div class="page-content">        
                ...
                <div class="page-content-wrap">                     
					<?php page_title("fa-trash-o","Deleted Companies"); ?>	
					<div class="grid">
					<div class="unit w-1-1">
						<form class="form-horizontal" action="<?php echo base_url('admin/edit/process/activate-companies'); ?>" method="POST" >
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<div class="panel-title-box">
										<h3>Restore Deleted Companies</h3>
										<span>Restore the deleted companies.</span>
									</div>
