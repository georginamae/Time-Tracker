<?php get_header('Joint Task','admin admin-joiny-task'); ?>
        <div class="page-container">
            ...
            <div class="page-content">        
                ...
                <!-- START BREADCRUMB -->
                <?php get_breadcrumbs('Assign Joint Task'); ?>
                <!-- END BREADCRUMB -->                       
                
                <!-- PAGE CONTENT WRAPPER -->
                <div class="page-content-wrap">                     
					<?php page_title("fa-sitemap"," Assign Joint Task"); ?>	
						<div class="panel panel-default">
								<div class="panel-heading">
									<div class="panel-title-box">
										<h3>Assign Joint Task</h3>
										<span>Fill out the fields to add new joint task</span>
									</div>
								...
								<div class="panel-body form-group-separated">
									<div class="row">
										<div class="col-md-12">
											<form class="form-horizontal" action="<?=base_url('admin/edit/process/assign-joint-task'); ?>" method="POST">
													<br>	
													<?php 
													...
													<div class="form-group">
														...
														<div class="col-md-6 col-xs-12">                                            
															<div class="input-group">
																...
																<input type="number" class="form-control" step="0.1" value="8" name="txtExpected" required />
															</div>                                            
														</div>
													</div>
													...
													<div class="form-group">
														<label class="col-md-3 col-xs-12 control-label">Assign To<br/>(Hold <b>ctr</b> to select multiple values)<br/><div id="joint-container"></div></label>
														<div class="col-md-6 col-xs-12">                                            
															<div class="input-group">
																<span class="input-group-addon"></span>
																<select multiple name="drpDev[]" class="form-control" id="joint-task" >
																	<?php
