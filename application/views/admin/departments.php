<?php get_header('View all Departments','admin admin-departments'); ?>
        <div class="page-container">
            ...
            <div class="page-content">        
                ...
                <div class="page-content-wrap">                     
					<?php page_title("fa-briefcase"," Departments"); ?>	
					<div class="grid">
					<div class="unit w-1-1">
						<form class="form-horizontal" action="<?php echo base_url('admin/edit/process/deactivate-departments'); ?>" method="POST" >
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<div class="panel-title-box">
										<h3>Departments</h3>
										<span>View all the Departments.</span>
									</div>
										...
										<?php
											...
											foreach($departments as $row){
												echo '<tr>';
													...
													echo '<td style="text-align:right;"><a class="btn btn-xs btn-success" href="'.base_url('admin/load/departments/'.$row->DepartmentID).'"><i class="fa fa-search"></i > View</a></td>';
												echo '</tr>';
												$ctr++;
											}
										?>
